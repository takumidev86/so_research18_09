...
LOAD DATA LOCAL INFILE '/mnt/e/data_dump_final_path/PostBlockDiff.csv' INTO TABLE `PostBlockDiff`
...
LOAD DATA LOCAL INFILE '/mnt/e/data_dump_final_path/PostVersion.csv' INTO TABLE `PostVersion`
CHARACTER SET utf8mb4
FIELDS TERMINATED BY ','
OPTIONALLY ENCLOSED BY '\"'
ESCAPED BY '\"'
...
LOAD DATA LOCAL INFILE '/mnt/e/data_dump_final_path/PostBlockVersion.csv' INTO TABLE `PostBlockVersion`
CHARACTER SET utf8mb4
FIELDS TERMINATED BY ','
OPTIONALLY ENCLOSED BY '\"'
ESCAPED BY '\"'
...
LOAD DATA LOCAL INFILE '/mnt/e/data_dump_final_path/PostVersionUrl.csv' INTO TABLE `PostVersionUrl`
CHARACTER SET utf8mb4
FIELDS TERMINATED BY ','
OPTIONALLY ENCLOSED BY '\"'
ESCAPED BY '\"'
...
LOAD DATA LOCAL INFILE '/mnt/e/data_dump_final_path/CommentUrl.csv' INTO TABLE `CommentUrl`
CHARACTER SET utf8mb4
FIELDS TERMINATED BY ','
OPTIONALLY ENCLOSED BY '\"'
ESCAPED BY '\"'
...
LOAD DATA LOCAL INFILE '/mnt/e/data_dump_final_path/TitleVersion.csv' INTO TABLE `TitleVersion`
CHARACTER SET utf8mb4
FIELDS TERMINATED BY ','
OPTIONALLY ENCLOSED BY '\"'
ESCAPED BY '\"'
